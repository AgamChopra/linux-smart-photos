    ...
    def catalog(self) -> list[ModelSpec]:
        return [
            ...
            ModelSpec(
                ...
                title="InsightFace SCRFD-10G-KPS",
                source_url="https://github.com/deepinsight/insightface/blob/master/detection/scrfd/README.md",
                download_url="https://1drv.ms/u/s!AswpsDO2toNKqycsF19UbaCWaLWx?e=F6i5Vm&download=1",
                storage_kind="file",
                local_path="insightface/models/antelope/scrfd_10g_bnkps.onnx",
                summary="Official SCRFD-10G-KPS ONNX detector for faster GPU-first human face detection.",
                license_note="InsightFace pretrained model packs are for non-commercial research purposes only.",
                recommended=True,
            ),
            ModelSpec(
